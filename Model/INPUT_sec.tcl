...
set EcWall	[expr 33000.*pow(0.140 + 8./1000,1.5)*sqrt(8.)*$ksi];	# Young's Modulus of Concrete
...
layer straight $SteelMatTag 6 [expr 2.*$Adb9] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb9] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb9] [expr $C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb9] [expr $C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]

#Steel rebar in web
layer straight $SteelMatTag 23 [expr 2.*$Adb9] [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr - $thick/2. + $cover + 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 23 [expr 2.*$Adb9] [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr + $thick/2. - $cover - 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr + $thick/2. - $cover - 1]
...
layer straight $SteelMatTag 9 $Adb10 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 5 $Adb10 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $cover + 1]
layer straight $SteelMatTag 5 $Adb10 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $be - 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $be - 1]
...
set EcWall	[expr 33000.*pow(0.140 + 7./1000,1.5)*sqrt(7.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
set GcWall 	[expr $EcWall/(2.0*(1.0+$nuc))];						# Shear Modulus of Concrete
...
#Steel rebar in flanges
layer straight $SteelMatTag 6 [expr 2.*$Adb8] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb8] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb8] [expr $C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 [expr 2.*$Adb8] [expr $C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]

#Steel rebar in web
layer straight $SteelMatTag 23 [expr 2.*$Adb8] [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr - $thick/2. + $cover + 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 23 [expr 2.*$Adb8] [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr + $thick/2. - $cover - 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr + $thick/2. - $cover - 1]

#Steel rebars in boundary elements
layer straight $SteelMatTag 9 $Adb9 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 9 $Adb9 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 5 $Adb9 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $cover + 1]
layer straight $SteelMatTag 5 $Adb9 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $be - 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $be - 1]
...
layer straight $SteelMatTag 7 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr + $thick/2. - $cover - 1] [expr -$C_dim1 - $thick/2. + $ce - $cover - 1] [expr $Centr + $thick/2. - $cover - 1]
layer straight $SteelMatTag 3 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. + 10] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr + $thick/2. - 10]
layer straight $SteelMatTag 3 $Adb8 [expr -$C_dim1 - $thick/2. + $ce - $cover - 1] [expr $Centr - $thick/2. + 10] [expr -$C_dim1 - $thick/2. + $ce - $cover - 1] [expr $Centr + $thick/2. - 10]
...
#Steel rebars in boundary elements
layer straight $SteelMatTag 9 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 9 $Adb8 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 4 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $cover + 1]
layer straight $SteelMatTag 4 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 6] [expr -$C_dim2 + $be - 1] [expr -$C_dim1 + $thick/2. - $cover - 6] [expr -$C_dim2 + $be - 1]
...
set EcWall	[expr 33000.*pow(0.140 + 6./1000,1.5)*sqrt(6.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
set GcWall 	[expr $EcWall/(2.0*(1.0+$nuc))];						# Shear Modulus of Concrete
...
layer straight $SteelMatTag 7 $Adb8 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 2 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 10] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 10] [expr -$C_dim2 + $cover + 1]
layer straight $SteelMatTag 2 $Adb8 [expr -$C_dim1 - $thick/2. + $cover + 10] [expr -$C_dim2 + $be - 1] [expr -$C_dim1 + $thick/2. - $cover - 10] [expr -$C_dim2 + $be - 1]
...
#Steel rebar in flanges
layer straight $SteelMatTag 10 $Adb6 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 10 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 10 $Adb6 [expr $C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 10 $Adb6 [expr $C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]

#Steel rebar in web
layer straight $SteelMatTag 37 $Adb6 [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr - $thick/2. + $cover + 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 37 $Adb6 [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr + $thick/2. - $cover - 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr + $thick/2. - $cover - 1]
...
#Steel rebar in flanges
layer straight $SteelMatTag 6 $Adb6 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 $Adb6 [expr $C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. - 8]
layer straight $SteelMatTag 6 $Adb6 [expr $C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be + 8] [expr $C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. - 8]

#Steel rebar in web
layer straight $SteelMatTag 18 $Adb6 [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr - $thick/2. + $cover + 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 18 $Adb6 [expr -$C_dim1 - $thick/2. + $ce + 8] [expr $Centr + $thick/2. - $cover - 1] [expr $C_dim1 + $thick/2. - $ce - 8] [expr $Centr + $thick/2. - $cover - 1]

#Steel rebars in boundary elements 
layer straight $SteelMatTag 5 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 - $thick/2. + $cover + 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 5 $Adb6 [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $cover + 1] [expr -$C_dim1 + $thick/2. - $cover - 1] [expr -$C_dim2 + $be - 1]
layer straight $SteelMatTag 2 $Adb6 -$C_dim1 [expr -$C_dim2 + $cover + 1] -$C_dim1 [expr -$C_dim2 + $be - 1]
...
#Steel rebars in corner elements
layer straight $SteelMatTag 5 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr - $thick/2. + $cover + 1] [expr -$C_dim1 - $thick/2. + $ce - $cover - 1] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 5 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] [expr $Centr + $thick/2. - $cover - 1] [expr -$C_dim1 - $thick/2. + $ce - $cover - 1] [expr $Centr + $thick/2. - $cover - 1]
layer straight $SteelMatTag 2 $Adb6 [expr -$C_dim1 - $thick/2. + $cover + 1] $Centr [expr -$C_dim1 - $thick/2. + $ce -$cover - 1] $Centr

layer straight $SteelMatTag 5 $Adb6 [expr $C_dim1 + $thick/2. - $ce + $cover + 1] [expr $Centr - $thick/2. + $cover + 1] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr - $thick/2. + $cover + 1]
layer straight $SteelMatTag 5 $Adb6 [expr $C_dim1 + $thick/2. - $ce + $cover + 1] [expr $Centr + $thick/2. - $cover - 1] [expr $C_dim1 + $thick/2. - $cover - 1] [expr $Centr + $thick/2. - $cover - 1]
layer straight $SteelMatTag 2 $Adb6 [expr $C_dim1 + $thick/2. - $ce + $cover + 1] $Centr [expr $C_dim1 + $thick/2. -$cover - 1] $Centr
...
set EcCB	[expr 33000.*pow(0.140 + 8./1000,1.5)*sqrt(8.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
...
fiber 0 0 [expr 8.*$Adb8] $SteelMatTag
}
...
set EcCB	[expr 33000.*pow(0.140 + 7./1000,1.5)*sqrt(7.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
set GcCB 	[expr $EcCB/(2.0*(1.0+$nuc))];							# Shear Modulus of Concrete
...
set EcCB	[expr 33000.*pow(0.140 + 6./1000,1.5)*sqrt(6.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
set GcCB 	[expr $EcCB/(2.0*(1.0+$nuc))];							# Shear Modulus of Concrete
...
set Ec_col	[expr 33000.*pow(0.140 + 5./1000,1.5)*sqrt(5.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
...
set Ec_col	[expr 33000.*pow(0.140 + 6./1000,1.5)*sqrt(6.)*$ksi];	# Young's Modulus of Concrete
set nuc 0.2;														# Poisson's Ratio of Concrete
set Gc_col 	[expr $Ec_col/(2.0*(1.0+$nuc))];						# Shear Modulus of Concrete
...
section Fiber $C12_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 6 6 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]
...
section Fiber $C16_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
...
section Fiber $C20_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 8 8 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]
...
section Fiber $C24_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 10 10 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]
...
section Fiber $C28_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
...
section Fiber $C32_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 12 12 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]
...
section Fiber $C36_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 12 12 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]

layer straight $SteelMatTag 5 $Adb9 [expr -$dim/2. + 2.] [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr -$dim/2. + 2.]
layer straight $SteelMatTag 5 $Adb9 [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.]
layer straight $SteelMatTag 3 $Adb9 [expr -$dim/2. + 2.] [expr -8.*$in] [expr -$dim/2. + 2.] [expr 8.*$in]
layer straight $SteelMatTag 3 $Adb9 [expr $dim/2. - 2.] [expr -8.*$in] [expr $dim/2. - 2.] [expr 8.*$in]
...
section Fiber $C40_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 12 12 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]

layer straight $SteelMatTag 6 $Adb9 [expr -$dim/2. + 2.] [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr -$dim/2. + 2.]
layer straight $SteelMatTag 6 $Adb9 [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.]
layer straight $SteelMatTag 4 $Adb9 [expr -$dim/2. + 2.] [expr -10.5*$in] [expr -$dim/2. + 2.] [expr 10.5*$in]
layer straight $SteelMatTag 4 $Adb9 [expr $dim/2. - 2.] [expr -10.5*$in] [expr $dim/2. - 2.] [expr 10.5*$in]
...
section Fiber $C44_6ksi -GJ [expr $Gc_col*$Jcol] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ

patch rect $unconfinedConc6 15 15 [expr -$dim/2.] [expr -$dim/2.] [expr $dim/2.] [expr $dim/2.]

layer straight $SteelMatTag 6 $Adb10 [expr -$dim/2. + 2.] [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr -$dim/2. + 2.]
layer straight $SteelMatTag 6 $Adb10 [expr -$dim/2. + 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.] [expr $dim/2. - 2.]
layer straight $SteelMatTag 4 $Adb10 [expr -$dim/2. + 2.] [expr -12.*$in] [expr -$dim/2. + 2.] [expr 12.*$in]
layer straight $SteelMatTag 4 $Adb10 [expr $dim/2. - 2.] [expr -12.*$in] [expr $dim/2. - 2.] [expr 12.*$in]
...
# ################################################
# WALL SECTION 20 in 6 ksi PODIUMS
set recWall20_6_pod $secTag
incr secTag 1
...
section Fiber $recWall20_6_pod -GJ [expr $GcWall*$JWall] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
...
# ################################################
# WALL SECTION 20 in 6 ksi OFFICE
set recWall20_6_off $secTag
incr secTag 1
...
section Fiber $recWall20_6_off -GJ [expr $GcWall*$JWall] {
#patch rect $matTag $numSubdivY $numSubdivZ $yI $zI $yJ $zJ
...
#Steel rebar in web
layer straight $SteelMatTag 17 $Adb6 [expr -$thick/2. + $cover + 1] [expr -$length/2. + 11] [expr -$thick/2. + $cover + 1] [expr $length/2. - 11]
layer straight $SteelMatTag 17 $Adb6 [expr $thick/2. - $cover - 1] [expr -$length/2. + 11] [expr $thick/2. - $cover - 1] [expr $length/2. - 11]
