...
puts $ModelFile "INPUT_sec_spm_NoPT.tcl"

#set Ec5	[expr 33000.*pow(0.140 + 5./1000,1.5)*sqrt(6.5)*$ksi];	# Young's Modulus of Concrete 5 ksi
#set Ec6	[expr 33000.*pow(0.140 + 6./1000,1.5)*sqrt(7.8)*$ksi];	# Young's Modulus of Concrete 6 ksi
...
#uniaxialMaterial Elastic $SteelString $Es
#puts $ModelFile "uniaxialMaterial Elastic $SteelString $Es"

# #######################################################

puts $ModelFile "Concrete material, effective slab properties"
...
#uniaxialMaterial Concrete01 $stringConc5 $fpc $epsc $fpcu $epscu
#puts $ModelFile "uniaxialMaterial Concrete01 $stringConc5 $fpc $epsc $fpcu $epscu"

# 6 ksi
set stringConc6_eff $matTag;
incr matTag 1
#uniaxialMaterial Concrete02 $matTag $fpc $epsc0 $fpcu $epsU $lambda $ft $Ets
...
uniaxialMaterial Concrete02 $stringConc6_eff -$fpc -$epsc -$fpcu -$epscu $lambda $fr $Ets
puts $ModelFile "uniaxialMaterial Concrete02 $stringConc6_eff -$fpc -$epsc -$fpcu -$epscu $lambda $fr $Ets"

#uniaxialMaterial Concrete01 $stringConc6 $fpc $epsc $fpcu $epscu
#puts $ModelFile "uniaxialMaterial Concrete01 $stringConc6 $fpc $epsc $fpcu $epscu"
...
#uniaxialMaterial Concrete01 $stringConc6_12 $fpc $epsc $fpcu $epscu
#puts $ModelFile "uniaxialMaterial Concrete01 $stringConc6_12 $fpc $epsc $fpcu $epscu"
...
uniaxialMaterial Concrete02 $stringConc6 -$fpc -$epsc -$fpcu -$epscu $lambda $fr $Ets
puts $ModelFile "uniaxialMaterial Concrete02 $stringConc6 -$fpc -$epsc -$fpcu -$epscu $lambda $fr $Ets"
...
set string12x8_21_36_2num8 $secTag
incr secTag 1

section Fiber $string12x8_21_36_2num8 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/4.5] $stringConc5_eff;
fiber 0 0 [expr $t*$w1*3.5/4.5] $stringConc5;
fiber 0 0 [expr 2.*$Adb8] $SteelString;

}

set string12x8_21_36_3num8 $secTag
incr secTag 1

section Fiber $string12x8_21_36_3num8 -GJ 0.0 {
...
set string12x8_21_36_6num8 $secTag
incr secTag 1

section Fiber $string12x8_21_36_6num8 -GJ 0.0 {
...
set string14x8_21_36_2num8 $secTag
incr secTag 1

section Fiber $string14x8_21_36_2num8 -GJ 0.0 {
...
set string12x8_17_20_2num8 $secTag
incr secTag 1

section Fiber $string12x8_17_20_2num8 -GJ 0.0 {
...
set string12x8_17_20_3num8 $secTag
incr secTag 1

section Fiber $string12x8_17_20_3num8 -GJ 0.0 {
...
set string12x8_17_20_3num10 $secTag
incr secTag 1

section Fiber $string12x8_17_20_3num10 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/4.5] $stringConc5_eff;
fiber 0 0 [expr $t*$w1*3.5/4.5] $stringConc5;
fiber 0 0 [expr 3.*$Adb10] $SteelString;

}

set string12x8_17_20_4num10 $secTag
incr secTag 1

section Fiber $string12x8_17_20_4num10 -GJ 0.0 {
...
set string12x8_17_20_6num10 $secTag
incr secTag 1

section Fiber $string12x8_17_20_6num10 -GJ 0.0 {
...
set string14x8_17_20_3num10 $secTag
incr secTag 1

section Fiber $string14x8_17_20_3num10 -GJ 0.0 {
...
set string14x8_17_20_4num10 $secTag
incr secTag 1

section Fiber $string14x8_17_20_4num10 -GJ 0.0 {
...
set string14x8_17_20_6num10 $secTag
incr secTag 1

section Fiber $string14x8_17_20_6num10 -GJ 0.0 {
...
set string12x8_12_16_2num8 $secTag
incr secTag 1

section Fiber $string12x8_12_16_2num8 -GJ 0.0 {
...
set string12x8_12_16_8num8 $secTag
incr secTag 1

section Fiber $string12x8_12_16_8num8 -GJ 0.0 {
...
set string12x8_12_16_4num10 $secTag
incr secTag 1

section Fiber $string12x8_12_16_4num10 -GJ 0.0 {
...
set string12x8_12_16_5num10 $secTag
incr secTag 1

section Fiber $string12x8_12_16_5num10 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/4.5] $stringConc5_eff;
fiber 0 0 [expr $t*$w1*3.5/4.5] $stringConc5;
fiber 0 0 [expr 5.*$Adb10] $SteelString;
...
set string12x8_12_16_10num10 $secTag
incr secTag 1

section Fiber $string12x8_12_16_10num10 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/4.5] $stringConc5_eff;
fiber 0 0 [expr $t*$w1*3.5/4.5] $stringConc5;
fiber 0 0 [expr 10.*$Adb10] $SteelString;
...
set string14x8_12_16_3num8 $secTag
incr secTag 1

section Fiber $string14x8_12_16_3num8 -GJ 0.0 {
...
set string14x8_12_16_6num8 $secTag
incr secTag 1

section Fiber $string14x8_12_16_6num8 -GJ 0.0 {
...
set string14x8_12_16_4num10 $secTag
incr secTag 1

section Fiber $string14x8_12_16_4num10 -GJ 0.0 {
...
set string14x8_12_16_5num10 $secTag
incr secTag 1

section Fiber $string14x8_12_16_5num10 -GJ 0.0 {
...
set string12x12_11_5num8 $secTag
incr secTag 1

section Fiber $string12x12_11_5num8 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/3.] $stringConc6_12_eff;
fiber 0 0 [expr $t*$w1*2/3.] $stringConc6_12;
fiber 0 0 [expr 5.*$Adb8] $SteelString;
...
set string12x12_11_10num8 $secTag
incr secTag 1

section Fiber $string12x12_11_10num8 -GJ 0.0 {
...
set string12x12_11_5num10 $secTag
incr secTag 1

section Fiber $string12x12_11_5num10 -GJ 0.0 {
...
set string12x12_11_10num10 $secTag
incr secTag 1

section Fiber $string12x12_11_10num10 -GJ 0.0 {
...
set string12x12_11_11num10 $secTag
incr secTag 1

section Fiber $string12x12_11_11num10 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/3.] $stringConc6_12_eff;
fiber 0 0 [expr $t*$w1*2/3.] $stringConc6_12;
fiber 0 0 [expr 11.*$Adb10] $SteelString;
...
set string12x12_11_16num10 $secTag
incr secTag 1

section Fiber $string12x12_11_16num10 -GJ 0.0 {

fiber 0 0 [expr $t*$w1/3.] $stringConc6_12_eff;
fiber 0 0 [expr $t*$w1*2/3.] $stringConc6_12;
fiber 0 0 [expr 16.*$Adb10] $SteelString;
...
fiber 0 0 [expr $t*$w1/3.] $stringConc6_12_eff;
fiber 0 0 [expr $t*$w1*2/3.] $stringConc6_12;
#fiber 0 0 [expr $t*$w1] $Ec6String;
fiber 0 0 [expr 10.*$Adb4] $SteelString;

}

set string14x12_11_3num8 $secTag
incr secTag 1

section Fiber $string14x12_11_3num8 -GJ 0.0 {
...
set string14x12_11_5num8 $secTag
incr secTag 1

section Fiber $string14x12_11_5num8 -GJ 0.0 {
...
set string14x12_11_5num10 $secTag
incr secTag 1

section Fiber $string14x12_11_5num10 -GJ 0.0 {
...
set string14x12_11_8num10 $secTag
incr secTag 1

section Fiber $string14x12_11_8num10 -GJ 0.0 {
...
set string12x8_4_10_2num8 $secTag
incr secTag 1

section Fiber $string12x8_4_10_2num8 -GJ 0.0 {
...
set string12x8_4_10_3num8 $secTag
incr secTag 1

section Fiber $string12x8_4_10_3num8 -GJ 0.0 {
...
set string12x8_4_10_5num8 $secTag
incr secTag 1

section Fiber $string12x8_4_10_5num8 -GJ 0.0 {
...
set string12x8_4_10_6num8 $secTag
incr secTag 1

section Fiber $string12x8_4_10_6num8 -GJ 0.0 {
...
set string12x8_4_10_10num8 $secTag
incr secTag 1

section Fiber $string12x8_4_10_10num8 -GJ 0.0 {
...
set string12x8_4_10_4num10 $secTag
incr secTag 1

section Fiber $string12x8_4_10_4num10 -GJ 0.0 {
...
set string12x8_4_10_5num10 $secTag
incr secTag 1

section Fiber $string12x8_4_10_5num10 -GJ 0.0 {
...
set string12x8_4_10_6num10 $secTag
incr secTag 1

section Fiber $string12x8_4_10_6num10 -GJ 0.0 {
...
set string12x8_4_10_10num10 $secTag
incr secTag 1

section Fiber $string12x8_4_10_10num10 -GJ 0.0 {
...
set string14x8_4_10_2num8 $secTag
incr secTag 1

section Fiber $string14x8_4_10_2num8 -GJ 0.0 {
...
set string14x8_4_10_3num8 $secTag
incr secTag 1

section Fiber $string14x8_4_10_3num8 -GJ 0.0 {
...
set string14x8_4_10_5num8 $secTag
incr secTag 1

section Fiber $string14x8_4_10_5num8 -GJ 0.0 {
...
set string14x8_4_10_4num10 $secTag
incr secTag 1

section Fiber $string14x8_4_10_4num10 -GJ 0.0 {
...
set string14x8_4_10_5num10 $secTag
incr secTag 1

section Fiber $string14x8_4_10_5num10 -GJ 0.0 {
...
set string14x8_4_10_8num10 $secTag
incr secTag 1

section Fiber $string14x8_4_10_8num10 -GJ 0.0 {
...
set string14x12_3_4num8 $secTag
incr secTag 1

section Fiber $string14x12_3_4num8 -GJ 0.0 {
...
set string14x12_3_5num8 $secTag
incr secTag 1

section Fiber $string14x12_3_5num8 -GJ 0.0 {
...
set string14x12_3_5num10 $secTag
incr secTag 1

section Fiber $string14x12_3_5num10 -GJ 0.0 {
...
set string14x12_3_8num10 $secTag
incr secTag 1

section Fiber $string14x12_3_8num10 -GJ 0.0 {
...
set string14x12_3_11num10 $secTag
incr secTag 1

section Fiber $string14x12_3_11num10 -GJ 0.0 {
...
set string12x12_3_5num8 $string12x12_11_5num8
set string12x12_3_4num10 $string12x12_11_4num10
set string12x12_3_5num10 $string12x12_11_5num10
set string12x12_3_6num10 $string12x12_11_6num10
set string12x12_3_8num10 $string12x12_11_8num10
set string12x12_3_11num10 $string12x12_11_11num10
...
set string12x8_1_2_8num10 $secTag
incr secTag 1

section Fiber $string12x8_1_2_8num10 -GJ 0.0 {
...
set string14x8_1_2_8num10 $secTag
incr secTag 1

section Fiber $string14x8_1_2_8num10 -GJ 0.0 {
