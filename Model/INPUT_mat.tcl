...
set fr		[expr 11.7*sqrt(6500.)*$psi];							# Concrete tensile strength
...
set epsc	[expr 2.*$fpc/$EcWall];									# Concrete strength at maximum strength
set fpcu	[expr $fcuFactor*$fpc];									# Concrete crushing strength
set fr		[expr 11.7*sqrt(7800.)*$psi];							# Concrete tensile strength
...
set epsc	[expr 2.*$fpc/$EcWall];									# Concrete strength at maximum strength
set fpcu	[expr $fcuFactor*$fpc];									# Concrete crushing strength
set fr		[expr 11.7*sqrt(9100.)*$psi];							# Concrete tensile strength
...
set epsc	[expr 2.*$fpc/$EcWall];									# Concrete strength at maximum strength
set fpcu	[expr $fcuFactor*$fpc];									# Concrete crushing strength
set fr		[expr 11.7*sqrt(10400.)*$psi];							# Concrete tensile strength
